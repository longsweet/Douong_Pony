                                            ...
                                            <td class="tf-cart-item_product">
                                                ...
                                                <div class="cart-info">
                                                    ...
                                                    <form method="POST" action="<?= BASE_URL ?>?act=update-cart">
                                                        ...
                                                        <button type="submit" class="remove-cart" style="border:none; background:none; color:red; cursor:pointer;">Remove</button>
                                                    </form>
                                                </div>
                                            </td>
                        ...
                        <div class="tf-cart-footer-inner">
                            <div class="tf-page-cart-checkout">
                                ...
                                <div class="cart-checkout-btn">
                                    <?php if (count($data) > 0) : ?>
                                        <a href="<?= BASE_URL ?>?act=check-out" class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
                                            <span>Check out</span>
                                        </a>
                                    <?php endif; ?>
                                </div>

                                <?= include 'App/Views/Users/layouts/long.php' ?>
                            </div>
                        </div>
                    </div>
                </div>

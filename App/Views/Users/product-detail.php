...
<head>
  <meta charset="utf-8">
  <title>MHT Tea - Detail Product</title>
      ...
      <div class="container">
        <div class="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
          <div class="tf-breadcrumb-list">
            <a href="<?= BASE_URL ?>" class="text">Trang chủ</a>
            <i class="icon icon-arrow-right"></i>
            <a href="<?= BASE_URL ?>?act=shop" class="text">Sản phẩm</a>
            <i class="icon icon-arrow-right"></i>
                  ...
                  <div class="tab-reviews write-cancel-review-wrap">
                    <div class="tab-reviews-heading">
                      <div class="top">
                        <div class="text-center">
                          ...
                          <p>(<?= count($ratingProduct) ?> Đánh giá)</p>
                        </div>
                        <?php
                        $count5 = 0;
                        $count4 = 0;
                        ...
                        <div class="rating-score">
                          <div class="item">
                            ...
                            <i class="icon icon-star"></i>
                            <div class="line-bg">
                              <div style="width: <?= count($ratingProduct) != 0 ? ($count5 / count($ratingProduct)) * 100 : '0' ?>%;"></div>
                            </div>
                          ...
                          <div class="item">
                            ...
                            <i class="icon icon-star"></i>
                            <div class="line-bg">
                              <div style="width: <?= count($ratingProduct) != 0 ? ($count4 / count($ratingProduct)) * 100 : '0' ?>%;"></div>
                            </div>
                            <div class="number-2 text-caption-1">
                              <?= $count4 ?>
                            </div>
                          ...
                          <div class="item">
                            ...
                            <i class="icon icon-star"></i>
                            <div class="line-bg">
                              <div style="width: <?= count($ratingProduct) != 0 ? ($count3 / count($ratingProduct)) * 100 : '0' ?>%;"></div>
                            </div>
                            <div class="number-2 text-caption-1">
                              <?= $count3 ?>
                            </div>
                          ...
                          <div class="item">
                            ...
                            <i class="icon icon-star"></i>
                            <div class="line-bg">
                              <div style="width: <?= count($ratingProduct) != 0 ? ($count2 / count($ratingProduct)) * 100 : '0' ?>%;"></div>
                            </div>
                            <div class="number-2 text-caption-1">
                              <?= $count2 ?>
                            </div>
                          ...
                          <div class="item">
                            ...
                            <i class="icon icon-star"></i>
                            <div class="line-bg">
                              <div style="width: <?= count($ratingProduct) != 0 ? ($count1 / count($ratingProduct)) * 100 : '0' ?>%;"></div>
                            </div>
                            <div class="number-2 text-caption-1">
                              <?= $count1 ?>
                            </div>
                      ...
                      <div>
                        <div class="tf-btn btn-outline-dark fw-6 btn-comment-review btn-cancel-review">Thôi khỏi viết</div>
                        <?php if (isset($_SESSION['users'])): ?>
                    ...
                    <div class="reply-comment cancel-review-wrap">
                      <div class="d-flex mb_24 gap-20 align-items-center justify-content-between flex-wrap">
                        <h5 class=""><?= count($comment) ?> Bình luận</h5>
                    ...
                    <form action="<?= BASE_URL ?>?act=write-review" method="post" class="form-write-review write-review-wrap">
                      <div class="heading">
                        ...
                        <input type="hidden" value="<?= $product->category_id ?>" name="categoryId"> <!-- Truyền category_id -->
                        <h5>Viết đánh giá:</h5>
                      ...
                      <div class="form-content">
                        <fieldset class="box-field">
                          <label class="label">Phản hồi</label>
                          <textarea rows="4" placeholder="Viết phản hồi của bạn ở đây" tabindex="2" aria-required="true" required="" name="comment"></textarea>
                        </fieldset>
                      </div>
      ...
      <div class="container">
        ...
        <div class="hover-sw-nav hover-sw-2">
          <div dir="ltr" class="swiper tf-sw-product-sell wrap-sw-over swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="15" data-pagination="2" data-pagination-md="3" data-pagination-lg="3">
            <div class="swiper-wrapper" id="swiper-wrapper-2a107c4f75fcd2e9e" aria-live="polite" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
              <?php
              $count = 1;
              $total = count($category);

              foreach ($category as $key => $value): ?>
                <div class="swiper-slide swiper-slide-active" lazy="true" role="group" aria-label="<?= $count . ' / ' . $total ?>" style="width: 337.5px; margin-right: 30px;">
          ...
          <div class="nav-sw nav-next-slider nav-next-product box-icon w_46 round swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-2a107c4f75fcd2e9e" aria-disabled="true"><span class="icon icon-arrow-left"></span></div>
          <div class="nav-sw nav-prev-slider nav-prev-product box-icon w_46 round" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-2a107c4f75fcd2e9e" aria-disabled="false"><span class="icon icon-arrow-right"></span></div>
          ...
          <li class="nav-mb-item">
            ...
            <div id="dropdown-menu-four" class="collapse">
              <ul class="sub-nav-menu" id="sub-menu-navigation">
                ...
                <li><a href="<?= BASE_URL ?>?act=shopping-cart" class="sub-nav-link line-clamp">View cart</a></li>
              ...
              <div class="tf-mini-cart-sroll">
                ...
                <div class="tf-minicart-recommendations">
                  <div class="tf-minicart-recommendations-heading">
                    ...
                    <div class="sw-dots small style-2 cart-slide-pagination swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span></div>
                  </div>
                  <div dir="ltr" class="swiper tf-cart-slide swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                    <div class="swiper-wrapper" id="swiper-wrapper-55e58d1022c4e10dfd" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                      <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 2" style="width: 363px;">
                      ...
                      <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" style="width: 363px;">
                        <div class="tf-minicart-recommendations-item">
                          <div class="tf-minicart-recommendations-item-image">
                            <a href="product-detail.html">

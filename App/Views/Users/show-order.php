                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($value->status == 'pending'): ?>
                                    <span class="badge text-bg-warning">Chờ xử lí</span>
                            ...
                            <td class="text-end">
                                <a href="<?= BASE_URL ?>?act=show-order-detail&order_id=<?= $value->id ?>" class="btn btn-success">Order Detail</a>

                                <?php if ($value->status === 'pending'): ?>
                                    <a href="<?=BASE_URL?>?act=cancel-order&order_id=<?=$value->id?>" class="btn btn-danger" onclick="            return confirm('Bạn có muốn hủy đơn không')">Cancel</a>

                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="new-category.html" class="">
                                                    <div class="text">Tạo danh mục mới</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="add-attributes.html" class="">
                                                    <div class="text">Thêm thuộc tính</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="https://themesflat.co/html/ecomus/index.html" class="">
                                                    <div class="text">Xem cửa hàng</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                            ...
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow">
                                    ...
                                    <div class="box-content-search" id="box-content-search">
                                        <ul class="mb-24">
                                            <li class="mb-14">
                                                <div class="body-title">Top sản phẩm bán chạy nhất</div>
                                            </li>
                                            <li class="mb-14">
                                        ...
                                        <ul class="">
                                            <li class="mb-14">
                                                <div class="body-title">Đặt mua sản phẩm</div>
                                            </li>
                                            <li class="mb-14">
                                                <div class="divider"></div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    ...
                                                    <div class="flex-grow">
                                                        ...
                                                        <div class="text-tiny">Xin chào?</div>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    ...
                                                    <div class="flex-grow">
                                                        ...
                                                        <div class="text-tiny">Bạn có ở đây không?</div>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    ...
                                                    <div class="flex-grow">
                                                        ...
                                                        <div class="text-tiny">Quan tâm tới?</div>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    ...
                                                    <div class="flex-grow">
                                                        ...
                                                        <div class="text-tiny">Được thôi...Chúng ta có thỏa thuận không?</div>
                                                    </div>
                                                </div>
                                            </li>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton2">
                                            ...
                                            <li>
                                                <div class="message-item item-3">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Đơn hàng đã được vận chuyển thành công</div>
                                            ...
                                            <li>
                                                <div class="message-item item-4">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Đơn hàng đang chờ xử lý: <span>ID 305830</span></div>
                                ...
                                <div class="popup-wrap apps type-header">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4">
                                            ...
                                            <li><a href="#" class="tf-button w-full">Xem tất cả app</a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-text text-main-dark">Vũ Như Định</span>
                                ...
                                <div class="wg-box">
                                    ...
                                    <form action="<?= BASE_URL ?>?role=admin&act=category-update&id=<?= $_GET['id'] ?>" method="post">
                                        <div class="mb-5">
                                            ...
                                            class="form-control" value="<?= $categories->id ?>">
                                        ...
                                        <div class="cols gap10">
                                            <a href="<?= BASE_URL ?>?role=admin&act=category" class="tf-button style-3 w380" type="submit"> Quay về</a>
                                        </div>

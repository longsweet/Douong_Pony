...
<body class="preload-wrapper popup-loader">
    ...
    <div class="modal fullRight fade modal-shopping-cart" id="shoppingCart">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="header">
                    <div class="title fw-5">Shopping</div>
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                </div>
                <div class="wrap">
                                    ...
                                    <div class="tf-mini-cart-items">
                                        <div class="tf-mini-cart-item">
                                            ...
                                            <div class="tf-mini-cart-info">
                                                <a class="title link" href="product-detail.html">Trà sữa trân châu</a>
                                                <!-- <div class="meta-variant">Light gray</div> -->
                                                <div class="price fw-6">45.000d</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="wrap">
                        <div class="tf-product-info-item">
                            ...
                            <div class="content">
                                <a href="product-detail.html">Ô long sữa trân châu ngũ cốc
                                </a>
                                <div class="tf-product-info-price">

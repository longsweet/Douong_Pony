                ...
                <div class="section-menu-left">
                    <!-- <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img id="logo_header" alt="" src="/html/" style="width: 150px; height: auto;">
                                ...
                                <div class="tf-section-4 mb-30">
                                        ...
                                        <div class="top">
                                            <div class="flex items-center gap14">
                                                ...
                                                <div>
                                                    <div class="flex gap10 items-center">
                                                        <div class="body-text mt-2 mb-4">Tổng thu nhập</div>
                                            ...
                                            <div class="dropdown default">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="view-all">Hàng tuần<i class="icon-chevron-down"></i></span>
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>  
                                                        <a href="javascript:void(0);">Hàng tháng</a>
                                                    </li>
                                                    <li>  
                                                        <a href="javascript:void(0);">Hàng năm</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="wg-chart-default">
                                        <div class="top">
                                            <div class="flex items-center gap14">
                                                ...
                                                <div>
                                                    <div class="flex gap15 items-center">
                                                        <div class="body-text mt-2 mb-4">Tổng số đơn đặt hàng</div>
                                            ...
                                            <div class="dropdown default">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="view-all">Hàng tháng<i class="icon-chevron-down"></i></span>
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>  
                                                        <a href="javascript:void(0);">Hàng tuần</a>
                                                    </li>
                                                    <li>  
                                                        <a href="javascript:void(0);">Hàng năm</a>
                                                    </li>
                                    ...
                                    <div class="wg-chart-default">
                                        <div class="top">
                                            <div class="flex items-center gap14">
                                                ...
                                                <div>
                                                    <div class="flex gap9 items-center">
                                                        <div class="body-text mt-2 mb-4">Khách hàng</div>
                                            ...
                                            <div class="dropdown default">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="view-all">Hàng năm<i class="icon-chevron-down"></i></span>
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>  
                                                        <a href="javascript:void(0);">Hàng tháng</a>
                                    ...
                                    <div class="wg-chart-default">
                                        <div class="top">
                                            <div class="flex items-center gap14">
                                                ...
                                                <div>
                                                    <div class="flex gap10 items-center">
                                                        <div class="body-text mt-2 mb-4">Số dư của tôi</div>
                                    ...
                                    <div class="wg-box">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="dropdown default style-box">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <a href="product-list.html" class="view-all">Hàng năm<i class="icon-chevron-down"></i></a>
                                                </button>
                                    ...
                                    <div class="flex gap20 flex-wrap-mobile">
                                        ...
                                        <div class="wg-box w-half">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="dropdown default style-box">
                                                    <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <a href="product-list.html" class="view-all">Hàng tuần<i class="icon-chevron-down"></i></a>
                                                    </button>
                                                    <ul class="dropdown-menu">
                                                        <li>  
                                                            <a href="javascript:void(0);">Hàng năm</a>
                                            ...
                                            <div class="flex flex-wrap gap40">
                                                <div>
                                                    <div class="mb-1">
                                                        <div class="block-legend">
                                                            <div class="text-tiny">Du khách</div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="flex gap20">
                                                <div class="block-legend style-1 w-full">
                                                    ...
                                                    <div class="text-tiny">Truyền thống xã hội</div>
                                                </div>
                                                <div class="block-legend style-1 w-full">
                                                ...
                                                <div class="block-legend style-1 w-full">
                                                    <div class="dot t3"></div>
                                                    <div class="text-tiny">Cửa hàng</div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /top-product -->
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-recent-orders">
                                            <ul class="table-title flex gap20 mb-14">
                                                ...
                                                <li>
                                                    <div class="body-title text-main-dark">ID sản phẩm</div>
                                                </li>
                                                <li>
                                            ...
                                            <ul class="flex flex-column has-divider-line has-line-bot">
                                                <li class="item wg-product gap20">
                                                    ...
                                                    <div>
                                                        <div class="block-available fw-7">Trả</div>
                                                    </div>
                                                </li>
                                                <li class="item wg-product gap20">
                                                    <div class="name">
                                                    ...
                                                    <div class="body-text text-main-dark mt-4">$138</div>
                                                    <div>
                                                        <div class="block-pending fw-7">Chưa thanh toán</div>
                                                    </div>
                                                </li>
                                                <li class="item wg-product gap20">
                                                    <div class="name">
                                                    ...
                                                    <div class="body-text text-main-dark mt-4">$138</div>
                                                    <div>
                                                        <div class="block-available fw-7">Hủy bỏ </div>
                                                    </div>
                                                </li>
                                                <li class="item wg-product gap20">
                                                    <div class="name">
                                                    ...
                                                    <div class="body-text text-main-dark mt-4">$138</div>
                                                    <div>
                                                        <div class="block-published fw-7">Xử lý</div>
                                                    </div>
                                                </li>
                                                <li class="item wg-product gap20">
                                                    <div class="name">
